...
Application::~Application() {
    // vkDestroyPipelineLayout(elyDevice.device(), pipelineLayout, nullptr);
}
...
//     elyPipeline =
//         std::make_unique<Ely::ElyPipeline>(elyDevice, pipelineConfig, "vertex_core.vert.spv",
//         "fragment_core.frag.spv");
// }
