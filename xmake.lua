...
target("elysium")
    ...
    after_build(function (target)
        ...
        os.rm("ElysiumEngine/mesh")
        os.mkdir("ElysiumEngine/mesh")
        os.cp("engine/mesh/*", "ElysiumEngine/mesh/")
        ...
        os.cp("engine/descriptor/*.hpp", "ElysiumEngine/includes/elysium/descriptor/")
